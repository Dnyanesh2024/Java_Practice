package Scrutiny_Flow_fertilizer_Manufacture;
...
import Scrutiny_Flow_fertilizer_Manufacture_Pages.Scrutiny_login_Page_Eparwana_Fert_Manufac;
...
public class Fertilizer_Manufacture_Dir_Agri_Test extends BaseClassA {
...
//	Fertilizer_NewLicense_State_Level fns;
	...
	Scrutiny_login_Page_Eparwana_Fert_Manufac Scrutiny_login_Page;
	@BeforeClass
	...
	public void  prinicipal_login(String Excel_path1) throws Exception {
		...
		ExcelReader er1 = new ExcelReader(Excel_path,1);
		 ...
		 //   fns = new Fertilizer_NewLicense_State_Level(driver);
	        ...
	        Scrutiny_login_Page= new Scrutiny_login_Page_Eparwana_Fert_Manufac(driver);
	...
	public void Scrutiny_Manufacture_Dir_Agri() throws Exception {
      ...
      //  Thread.sleep(22000);
		...
		// Scrutiny_login_Page.click_On_nextbtn(); //
		 ...
		 // Scrutiny_login_Page.click_On_nextbtn();
		  ...
		  //Fertilizer Type and Grade Information
		...
		////  MPCB Certificate
		 ...
		 // Scrutiny_login_Page.click_On_final_Recommend_For_Approval();
		  Scrutiny_login_Page.handle_Alert();
		  fns.click_On_ok_Button_After_Approve();
		  ...
		  Scrutiny_login_Page.click_on_Fertilizer_Manufacture_Dealer_License_Tab();
