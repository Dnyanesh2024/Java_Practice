...
import UploadDoc_cotton_Dealer.UploadDocumentsandPayment_cotton_Dealer_District;
...
public class UploadDocumentsandPayment_Cotton_Dealer_District_Test extends BaseClassA {
	
	
	Login_Page lp;
	Fertilizer_NewLicense_State_Level fns;
	
	UploadDocumentsandPayment_cotton_Dealer_District up;
	...
	public void setup(String Excel_path1) throws Exception {
		...
		up= new UploadDocumentsandPayment_cotton_Dealer_District(driver);
...
public void verify_GRAS_Payment_Details_Details() throws Throwable {
	...
	up.enter_Date_Of_Birth();
	/*
	 * up.click_on_challan_Payment_Date(); up.select_Month(er.getExcelData(43, 1));
	 * 
