...
public class Insecticide_Dealer_License_NewLicense_Test extends BaseClassA {
	Login_Page lp;
	Insecticide_Dealer_License_NewLicense_State_Level idl;
	...
	public void setup(String Excel_path1) throws Exception {
		...
		idl = new Insecticide_Dealer_License_NewLicense_State_Level(driver);

		up = new UploadDocumentsandPayment(driver);

		idl.click_on_Insecticide_Dealer_License_Tab();
		idl.click_On_New_License_State_Level();
...
//  Responsible Person Details
	...
	public void verify_Fertilizer_type_Grade() throws Exception {
		...
		idl.enter_Insect_License(er.getExcelData(40, 1));

		idl.click_On_insecSend_Request();
