package test.service_Fertilizer_Manufacture_License_State;
...
public class Fertilizer_Manufacture_NewLicense_State_Level_Test extends BaseClassA {
	Login_Page lp;
	Fertilizer_Manufacture_NewLicense_State_Level fm;
	...
	public void setup(String Excel_path1) throws Exception {
		...
		fm = new Fertilizer_Manufacture_NewLicense_State_Level(driver);
