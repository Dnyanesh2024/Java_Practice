package test.service_Insecticide_Manufacturing_License_Maharashtra;
...
import pages.service_Fertilizer_Manufacture_License_State.Fertilizer_Manufacture_NewLicense_State_Level;
import pages.service_Insecticide_Manufacturing_License_Maharashtra.Insecticide_Manufacturing_License_Maharashtra;
import pages_Eparwana.Login_Page;
import utility_Earwana.BaseClassA;
import utility_Earwana.ExcelReader;

public class Insecticide_Manufacturing_License_Maharashtra_Test extends BaseClassA {
	Login_Page lp;
	Insecticide_Manufacturing_License_Maharashtra fm;
	...
	public void setup(String Excel_path1) throws Exception {
		...
		fm = new Insecticide_Manufacturing_License_Maharashtra(driver);
        ...
        fm.click_on_Insecticide_Manufacturing_License_Maharashtra_Tab();
...
//  Responsible Person Details
	...
	public void verify_Responsibl_Perso_Details() throws Exception {
		...
		fm.Select_Is_same_as_Applicant(er.getExcelData(53, 0));
		
		fm.Select_Registered_Office_Type(er.getExcelData(52, 0));
		
		fm.Scroll_Down();

		fm.enter_Name_Of_Building_res(er.getExcelData(19, 1));

		fm.enter_Name_Of_Street_res(er.getExcelData(19, 3));

		fm.enter_Name_Of_Landmak_Res(er.getExcelData(19, 5));

		fm.Scroll_Down();

		fm.Select_State(er.getExcelData(12, 3));

		fm.Select_District_Res(er.getExcelData(19, 7));

		fm.Select_Taluka_res(er.getExcelData(19, 9));

		fm.enter_pincode_Res(er.getExcelData(19, 11));
	...
	public void verify_Place_of_Manufacturer_Details_() throws Exception {
		...
		fm.Select_Manufacturing_Unit_Address(er.getExcelData(54, 0));
		...
		fm.enter_Type_of_Document_of_Ownership(er.getExcelData(55, 0));
		
		fm.Select_Ownership_Details_of_Business(er.getExcelData(34, 3));

		fm.enter_part_mob_Num(er.getExcelData(28, 7));
		fm.enter_Details_of_Machinery_and_Laboratory(er.getExcelData(56, 0));
		fm.Upload_relevant_documents(er.getExcelData(59, 1));
		
		
		fm.click_Upload_Button();
...
/*
	...
	//   Chemical Type
	@Test(priority = 5)
	public void verify_Chemical_Type_Details() throws Exception {

		ExcelReader er = new ExcelReader(Excel_path, 0);
		fm.Select_Chemical_Type(er.getExcelData(64, 1));
		
		//fm.enter_Machinery_Name(er.getExcelData(2, 3));
		
		fm.enter_Composite_Formula_of_Insecticide(er.getExcelData(64, 3));
		
		fm.enter_Trade_Name(er.getExcelData(64, 5));
		fm.enter_RC_Num(er.getExcelData(65, 1));
		
		fm.click_on_RCDate();

		fm.select_Month(er.getExcelData(43, 2));

		fm.select_year(er.getExcelData(44, 2));

		fm.select_Date();
		fm.select_Under_Section(er.getExcelData(65, 3));
		fm.select_Registration_Validity_Type(er.getExcelData(65, 5));
		
		fm.Scroll_Down();
		fm.click_on_None_selected();
		fm.click_on_Crop();
		fm.click_On_Chemical_Add_Button();
	...
	public void verify_Experts_Staff_Details_of_Manufacture() throws Exception {
		...
		fm.enter_Date_Of_Birth1();

		fm.enter_Applicant_Educational_Qualification1(er.getExcelData(17, 7));

		fm.enter_Applicant_Designation1(er.getExcelData(17, 9));

		fm.enter_Applicant_Addhar1(er.getExcelData(17, 11));
		
		fm.enter_Mobile_No1(er.getExcelData(21, 1));

		fm.enter_Email_ID1(er.getExcelData(21, 3));

		fm.enter_Experience_in_years(er.getExcelData(45, 1));
	...
	//	fm.Select_Place_of_Manufacture(er.getExcelData(2, 1));
		...
		fm.click_On_Final_Submit_Button1();
		fm.click_On_ok_Button();
	...
	//	fm.click_On_PendingO();
		...
		fm.enter_Application_ID(er.getExcelData(22, 1));
		fm.Click_Send_PCbtn();
	...
	public void verify_Dashboard_Search() throws Exception{
		...
		fm.click_On_Fertilizer_Type_and_Grade();
