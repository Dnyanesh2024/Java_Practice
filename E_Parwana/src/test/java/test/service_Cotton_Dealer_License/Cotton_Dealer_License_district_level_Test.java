...
import pages.service_Cotton_Dealer_License.Cotton_Dealer_Licensee_District_Level;
import pages_Eparwana.Login_Page;
import utility_Earwana.BaseClassA;
import utility_Earwana.ExcelReader;

public class Cotton_Dealer_License_district_level_Test extends BaseClassA {
	
	Login_Page lp;
	Cotton_Dealer_Licensee_District_Level fm;
	...
	public void setup(String Excel_path1) throws Exception {
		...
		fm = new Cotton_Dealer_Licensee_District_Level(driver);
        ...
        fm.click_On_New_License_District_Level();
...

	{
        ...
        fm.Select_district(er.getExcelData(53, 1));
		Thread.sleep(2000);
