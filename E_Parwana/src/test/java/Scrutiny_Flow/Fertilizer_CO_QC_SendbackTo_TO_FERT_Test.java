...
public class Fertilizer_CO_QC_SendbackTo_TO_FERT_Test extends BaseClassA {
	...
	public void  CO_QC_login(String Excel_path1) throws Exception {
	...
	public void Scrutiny_CO_QC_Sendback() throws Exception {
     ExcelReader er = new ExcelReader(Excel_path, 0);
		...
		//  Scrutiny_login_Page.enter_Remarks(er1.getExcelData(15, 1));
		  ...
		  Scrutiny_login_Page.click_On_Send_back_to_TO_Fert();
