package UploadDoc_Fertilizer_Manufacture_State_Test;
...
public class UploadDocumentsandPayment_Fert_Manufacure_Test extends BaseClassA{
	
	
	Login_Page lp;
	Fertilizer_NewLicense_State_Level fns;
	
	UploadDocumentsandPayment_Fertilizer_Manufacture up;
	...
	public void setup(String Excel_path1) throws Exception {
		...
		up= new UploadDocumentsandPayment_Fertilizer_Manufacture(driver);
