...
import Scrutiny_Flow_Cotton_Dealer_Pages.Scrutiny_login_Page_Eparwana_Cotton_Dealer_District;
...
public class Cotton_Dealer_AO_AKO1_Test extends BaseClassA {
...
//	Fertilizer_NewLicense_State_Level fns;
	...
	Scrutiny_login_Page_Eparwana_Cotton_Dealer_District Scrutiny_login_Page;
	@BeforeClass
	...
	public void  prinicipal_login(String Excel_path1) throws Exception {
		...
		ExcelReader er1 = new ExcelReader(Excel_path,1);
		 ...
		 //   fns = new Fertilizer_NewLicense_State_Level(driver);
	        ...
	        Scrutiny_login_Page= new Scrutiny_login_Page_Eparwana_Cotton_Dealer_District(driver);
	...
	public void Scrutiny_Cotton_TO_Seed() throws Exception {
