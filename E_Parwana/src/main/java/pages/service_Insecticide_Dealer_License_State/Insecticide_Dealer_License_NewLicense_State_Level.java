package pages.service_Insecticide_Dealer_License_State;
...
public class  Insecticide_Dealer_License_NewLicense_State_Level {

	WebDriver driver;
	
	String Excel_path;

	public Insecticide_Dealer_License_NewLicense_State_Level(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//span[text()=' Insecticide Manufacturing License (Maharashtra)']")

	private WebElement Insecticide_Manufacturing_License;

	public void click_on_Insecticide_Manufacturing_License_Tab() {

		Insecticide_Manufacturing_License.click();
	...
	@FindBy(xpath = "//a[contains(@onclick,'InsecticidePC/SendPC?q=%2fVlGu5ryUQixgsswM1')]//span[text()='Send Principal Certificate']")

	private WebElement InsecticideP;

	public void click_on_pricipal_Certificate_Tab() {
	...
	private WebElement New_Licens_dist;

	public void click_On_New_License_District_Level() throws Exception {
       Thread.sleep(3000);
		New_Licens_dist.click();
	}
	...
	@FindBy(xpath = "//select[@id='ddlLicenseCategoryType']")
	private WebElement Applicant_Type;

	public void Select_Applicant_Type(String apptype) {
		Select s1 = new Select(Applicant_Type);
	...
	@FindBy(xpath = "//select[@id='CStateID_C']")
	private WebElement Statenw;

	public void Select_State(String st) throws Exception {
		
		Statenw.click();
		Select s1 = new Select(Statenw);
		Thread.sleep(5000);
		s1.selectByVisibleText(st);
	}


	@FindBy(xpath = "//ul/li/a/label[text()=' Akola']")
	...
	@FindBy(xpath = "//ul/li/a/label[text()=' Stock']")

	private WebElement Licence_Purpose;

	public void click_On_Licence_Purpose_Checkbox() {

		Licence_Purpose.click();
	...
	private WebElement Lincence_sub_Type;

	public void Select_License_Sub_Type(String Lincence_Sub_Type) throws Exception

	{

		Lincence_sub_Type.click();
		Select s1 = new Select(Lincence_sub_Type);
		Thread.sleep(3000);
		s1.selectByVisibleText(Lincence_Sub_Type);
	}

	@FindBy(xpath = "//*[@id=\"divLicenseCategory\"]/div/div/ul/li[4]/a/label")
	...
	@FindBy(xpath = "//input[@id='appPersonDetails_EducQual']")
	...
	@FindBy(xpath = "//input[@id='DesResponsibility']")

	private WebElement DesResponsibility;

	public void enter_DesResponsibility(String Des) throws Exception {

		// Thread.sleep(3000);

		DesResponsibility.sendKeys(Des);
	}

	@FindBy(xpath = "//input[@id='appPersonDetails_Designation']")
	...
	@FindBy(xpath = "//input[@id='ResiNameOfBuilding']")

	private WebElement NameBuildres;

	public void enter_Name_Of_Building_res(String Building) throws Exception {

		// Thread.sleep(3000);

		NameBuildres.sendKeys(Building);
	}
	...
	@FindBy(xpath = "//input[@id='ResiStreet']")

	private WebElement NameStreetres;

	public void enter_Name_Of_Street_res(String Street) throws Exception {

		// Thread.sleep(3000);

		NameStreetres.sendKeys(Street);
	...
	@FindBy(xpath = "//input[@id='ResiLandmark']")

	private WebElement NameLandmarkres;

	public void enter_Name_Of_Landmak_Res(String Landmark) throws Exception {

		// Thread.sleep(3000);

		NameLandmarkres.sendKeys(Landmark);
	...
	@FindBy(xpath = "//select[@id='CDistrictID_C']")
	private WebElement districtNameREs;

	public void Select_District_Res(String dist) throws Exception

	{

		// Lincence_sub_Type.click();
		Select s1 = new Select(districtNameREs);
		Thread.sleep(3000);
		s1.selectByVisibleText(dist);
	}
	...
	@FindBy(xpath = "//select[@id='CTalukaID_C']")
	private WebElement TalukaNameres;

	public void Select_Taluka_res(String tal) throws Exception

	{

		// Lincence_sub_Type.click();
		Select s1 = new Select(TalukaNameres);
		Thread.sleep(3000);
		s1.selectByVisibleText(tal);
	}
	...
	@FindBy(xpath = "//input[@id='ResiPincode']")

	private WebElement pincode_Res;

	public void enter_pincode_Res(String pin) throws Exception {

		// Thread.sleep(3000);

		pincode_Res.sendKeys(pin);
	...
	@FindBy(xpath = "//input[@id='appCommDetails_MobileNum']")
	...
	@FindBy(xpath = "//input[@id='appCommDetails_EmailAddr']")
	...
	@FindBy(xpath = "//button[@id='btnSave' and @type='submit']")
...
//	@FindBy(xpath = "//p[ substring-before(text(), '-')='APPLICANT INFORMATION SAVED SUCCESSFULLY ' ]")
	...
	public void write_Application_ID() throws Exception {
		...
		ExcelWritter er = new ExcelWritter(
				"C:\\Users\\Swapnil.Gedam\\eclipse-workspacemahait\\E_Parwana\\src\\main\\resources\\Insecticide_Dealer_State.xlsx",
				0);
	...
	@FindBy(xpath = "//button[contains (@style, 'display: inline-block; background-color') and @class='confirm']")

	private WebElement ok_Button;

	public void click_On_ok_Button_After_Approve() throws Exception {
	...
	@FindBy(xpath = "//select[@id='ddlFirmAddress']")
	...
	@FindBy(xpath = "//input[@id='firmAddrDetails_FirmOrgName']")
	...
	@FindBy(xpath = "//input[@id='firmCommnDetails_MobileNum']")
	...
	@FindBy(xpath = "//input[@id='firmCommnDetails_EmailAddr']")
	...
	public void enter_Email_ID_new(String pemail) throws Exception {

		// Thread.sleep(3000);

		Emailid.sendKeys(pemail);
	}
	...
	@FindBy(xpath = "//select[@id='ddlResPersonDetails']")
	private WebElement Responsibles_Person;
	public void Select_Responsible_Person_(String rpersonADD) throws Exception

	{

		// Lincence_sub_Type.click();
		Select s1 = new Select(Responsibles_Person);
		Thread.sleep(3000);
		s1.selectByVisibleText(rpersonADD);
	...
	@FindBy(xpath = "//select[@id='salesAddressDetails_OwnershipType']")
	...
	@FindBy(xpath = "//select[@id='ddlOwnPlaceBusiness']")
	private WebElement Ownership_DETails_of_Business;
	...
	private WebElement Length_New;

	public void enter_Length_New(String length) throws Exception {

		// Thread.sleep(3000);

		Length_New.sendKeys(length);
	}
	...
	@FindBy(xpath = "//input[@name='SalesDeclarationIns.Breadth']")

	private WebElement SalesDeclarationIns;

	public void enter_Breadh_New(String breadth) throws Exception {

		// Thread.sleep(3000);

		SalesDeclarationIns.sendKeys(breadth);
	}
	...
	private WebElement SalesHeight;

	public void enter_Height_New(String Height) throws Exception {

		// Thread.sleep(3000);

		SalesHeight.sendKeys(Height);
	}
	...
	public void enter_sales_Area(String Area) throws Exception {

		// Thread.sleep(3000);

		SalesArea.sendKeys(Area);
	}
	...
	private WebElement salesstorage;

	public void enter_sales_Storage(String strge) throws Exception {

		// Thread.sleep(3000);

		salesstorage.sendKeys(strge);
	}
	...
	private WebElement SalesFloor;

	public void enter_sales_floor(String floor) throws Exception {

		// Thread.sleep(3000);

		SalesFloor.sendKeys(floor);
	}
	...
	private WebElement salesWalls;

	public void enter_sales_Walls(String wls) throws Exception {

		// Thread.sleep(3000);

		salesWalls.sendKeys(wls);
	}
	...
	private WebElement Authentications;

	public void click_ON_Authentication_Sales() throws Exception {

		Thread.sleep(3000);

		Authentications.click();
		;
	}
	...
	private WebElement insectLicense;

	public void enter_Insect_License(String grade) throws Exception {

		// Thread.sleep(3000);

		insectLicense.sendKeys(grade);
	}

	
	@FindBy(xpath = "//input[@id='txtPCHolder']")

	private WebElement insectLicense_District;

	public void enter_Insect_License_for_District(String lic) throws Exception {

		// Thread.sleep(3000);

		insectLicense_District.sendKeys(lic);
	}
	...
	@FindBy(xpath = "//button[@id='btnSendRequestSoleDealer' and text()='Send Request']")

	private WebElement insecsendpc;

	public void click_On_insecSend_Request() throws Exception {
		Thread.sleep(3000);
		insecsendpc.click();

	}
	@FindBy(xpath = "//button[@id='btnSendRequest' and text()='Send Request']")

	private WebElement insecsendpc_District;

	public void click_On_insecSend_Request_For_District() throws Exception {
		Thread.sleep(3000);
		insecsendpc_District.click();
	...
	@FindBy(xpath = "//input[@id='dx-col-1']")

	private WebElement applicationid_insec;

	public void enter_Application_ID_For_Insec(String ID) throws Exception {

		 Thread.sleep(5000);

		applicationid_insec.sendKeys(ID);
	}
	...
	public void Click_Send_PCbtn() throws Exception {
		...
		//	String app = driver.findElement(By.xpath("//table/tbody[" + i + "]/tr/td[2]")).getText();
			...
			String app = driver.findElement(By.xpath("//div/div[6]/div/table/tbody/tr["+i+"]/td[1]")).getText();
			...
			if (app.contains(er.getExcelData(22, 1))) {
				...
				driver.findElement(By.xpath("//div[6]/div/table/tbody/tr["+i+"]/td[8]/div/button[1]")).click();
...
//Form O
	...
	@FindBy(xpath = "//div[5]/div/table/tbody/tr[1]/td[1]/div/div/span")
	...
	@FindBy(xpath = "//input[@id='chkDirectlyFromUs']")

	private WebElement chkDirectlyFromUs;

	public void click_On_chkDirectlyFromUs() throws Exception {

		Thread.sleep(2000);
		chkDirectlyFromUs.click();
	}
	@FindBy(xpath = "//input[@id='chkActAsDistributor']")

	private WebElement chkActAsDistributor;

	public void click_On_chkActAsDistributor() throws Exception {

		Thread.sleep(2000);
		chkActAsDistributor.click();
	}
	
	
	@FindBy(xpath = "//td[1]/div/div/div[1]/div[1]/div")

	private WebElement Upto_the_validity;

	public void click_On_Upto_the_validity() throws Exception {

		Thread.sleep(2000);
		Upto_the_validity.click();
	}
	
	
	@FindBy(xpath = "//button[@id='btnSubmitPC']")
...
@FindBy(xpath = "//a[contains (@href, '/InsecticideDealer/DetailsofInsecticides')]")
	
	private WebElement InsecticideDealer;
	
	public void click_On_InsecticideDealer() {
		
		InsecticideDealer.click();
	}
