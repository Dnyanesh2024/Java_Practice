...
public class  Insecticide_Dealer_License_NewLicense_District_Level {

	WebDriver driver;
	
	String Excel_path;

	public Insecticide_Dealer_License_NewLicense_District_Level(WebDriver driver) {
		this.driver = driver;
...
//	@FindBy(xpath = "//p[ substring-before(text(), '-')='APPLICANT INFORMATION SAVED SUCCESSFULLY ' ]")
	...
	public void write_Application_ID() throws Exception {
		...
		ExcelWritter er = new ExcelWritter(
				"C:\\Users\\Swapnil.Gedam\\eclipse-workspacemahait\\E_Parwana\\src\\main\\resources\\Insecticide_Dealer_District.xlsx",
				0);
