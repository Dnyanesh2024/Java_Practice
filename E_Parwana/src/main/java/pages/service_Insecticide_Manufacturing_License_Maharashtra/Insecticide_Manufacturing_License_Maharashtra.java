package pages.service_Insecticide_Manufacturing_License_Maharashtra;
...
public class  Insecticide_Manufacturing_License_Maharashtra {

	WebDriver driver;
	
	String Excel_path;

	public Insecticide_Manufacturing_License_Maharashtra(WebDriver driver) {
		this.driver = driver;
	...
	public void click_on_Insecticide_Manufacturing_License_Maharashtra_Tab() {

		Manuafacture_License.click();

	}

	@FindBy(xpath = "//li[@class='nav-item dropdown open']//div//span[text()='New License (Maharashtra)']")
	...
	public void enter_Date_Of_Birth1() {

		WebElement date = driver.findElement(By.xpath("//input[@id='StaffDetails_DOB']"));
		date.click();
		String dateval = "28/01/1993";

		selectDateByJS1(driver, date, dateval);
		// date.click();
		date.sendKeys(Keys.ENTER);
	}

	public static void selectDateByJS1(WebDriver driver, WebElement element, String dateval) {
	...
	@FindBy(xpath = "//input[@id='EXPStaffDetails_EducQual']")

	private WebElement eddquali1;

	public void enter_Applicant_Educational_Qualification1(String Education) throws Exception {

		// Thread.sleep(3000);

		eddquali1.sendKeys(Education);
	}
	...
	@FindBy(xpath = "//input[@id='EXPStaffDetails_Designation']")

	private WebElement desig1;

	public void enter_Applicant_Designation1(String design) throws Exception {

		// Thread.sleep(3000);

		desig1.sendKeys(design);
	}
	...
	private WebElement aadgnumber1;

	public void enter_Applicant_Addhar1(String Addharno) throws Exception {

		// Thread.sleep(3000);
		
		aadgnumber1.clear();

		aadgnumber1.sendKeys(Addharno);
	}
	...
	@FindBy(xpath = "//input[@id='EXPStaffDetails_ExpertExperience']")

	private WebElement Experience_in_years;

	public void enter_Experience_in_years(String pan) throws Exception {

		// Thread.sleep(3000);
		Experience_in_years.clear();

		Experience_in_years.sendKeys(pan);
	}
	...
	@FindBy(xpath = "//input[@id='EXPStaffDetails_ExpertMobileNo']")

	private WebElement mobnum1;

	public void enter_Mobile_No1(String mob) throws Exception {

		// Thread.sleep(3000);

		mobnum1.sendKeys(mob);
	}
	...
	@FindBy(xpath = "//input[@id='EXPStaffDetails_ExpertEmailID']")

	private WebElement Email1;

	public void enter_Email_ID1(String EmailNAME) throws Exception {

		// Thread.sleep(3000);

		Email1.sendKeys(EmailNAME);
	}
...
//	@FindBy(xpath = "//p[ substring-before(text(), '-')='APPLICANT INFORMATION SAVED SUCCESSFULLY ' ]")
	...
	public void write_Application_ID() throws Exception {
		...
		ExcelWritter er = new ExcelWritter(
				"C:\\Users\\Swapnil.Gedam\\eclipse-workspacemahait\\E_Parwana\\src\\main\\resources\\Insecticide_Manufacturing_License_Maharashtra.xlsx",
				0);
	...
	@FindBy(xpath = "//select[@id='ddlResAddressOffice']")
	private WebElement RESFirmAddress;

	public void Select_Registered_Office_Type(String AType) throws Exception

	{
		
		Thread.sleep(3000);
		RESFirmAddress.click();
		// Lincence_sub_Type.click();
		Select s1 = new Select(RESFirmAddress);
		Thread.sleep(5000);
		s1.selectByVisibleText(AType);
	}
	...
	private WebElement Is_same_as_Applicant;

	public void Select_Is_same_as_Applicant(String AType) throws Exception

	{
		
		Thread.sleep(3000);
		Is_same_as_Applicant.click();
		// Lincence_sub_Type.click();
		Select s1 = new Select(Is_same_as_Applicant);
		Thread.sleep(5000);
		s1.selectByVisibleText(AType);
	}
	
	
	@FindBy(xpath = "//select[@id='ddlPOMUnitAddr']")
	private WebElement Manufacturing_Unit_Address;

	public void Select_Manufacturing_Unit_Address(String AType) throws Exception

	{
		
		Thread.sleep(3000);
		Manufacturing_Unit_Address.click();
		// Lincence_sub_Type.click();
		Select s1 = new Select(Manufacturing_Unit_Address);
		Thread.sleep(5000);
		s1.selectByVisibleText(AType);
	}
	...
	@FindBy(xpath = "//textarea[@id='txtDetailsofMachineryandLaboratoryEquipments']")

	private WebElement Details_of_Machinery_and_Laboratory;

	public void enter_Details_of_Machinery_and_Laboratory(String pnum) throws Exception {

		// Thread.sleep(3000);

		Details_of_Machinery_and_Laboratory.sendKeys(pnum);
	}
	
	@FindBy(xpath = "//input[@id='FileUploadControl']")

	private WebElement documents;

	public void Upload_relevant_documents(String pnum) throws Exception {

		 Thread.sleep(3000);

		documents.sendKeys(pnum);
	}
	
	@FindBy(xpath = "//input[@id='OwnPlaceOfBusiness']")

	private WebElement Type_of_Document;

	public void enter_Type_of_Document_of_Ownership(String pnum) throws Exception {

		// Thread.sleep(3000);

		Type_of_Document.sendKeys(pnum);
	}
	...
	private WebElement Chemical_Add;

	public void click_On_Chemical_Add_Button() throws Exception {

		Thread.sleep(3000);
		Chemical_Add.click();
	}
	
	@FindBy(xpath = "//input[@id='btnUpload_']")
...
@FindBy(xpath = "//span[text()='None selected']")
	
	private WebElement None_selected;
	
	public void click_on_None_selected () {
		
		None_selected.click();
	}
	
	
@FindBy(xpath = "//label[text()=' Aerial Yam']")
	
	private WebElement crop;
	
	public void click_on_Crop () {
...
@FindBy(xpath = "//select[@id='UnderSection']")
	
	private WebElement Under_Section;
	public void select_Under_Section(String Mon) throws Exception {
		
		Select s1 = new Select(Under_Section);
		Thread.sleep(3000);
		s1.selectByVisibleText(Mon);
		
	}
	
@FindBy(xpath = "//select[@id='ddlRegValidityType']")
	
	private WebElement Validity_Type;
	public void select_Registration_Validity_Type
(String Mon) throws Exception {
		
		Select s1 = new Select(Validity_Type);
		Thread.sleep(3000);
		s1.selectByVisibleText(Mon);
...
@FindBy(xpath = "//a[text()='Final Submit']")
	...
	private WebElement finalsubmit1;
	
	public void click_On_Final_Submit_Button1() throws Exception {
		
		JavascriptExecutor js = (JavascriptExecutor)driver;	
		Thread.sleep(2000);
		js.executeScript("arguments[0].click();", finalsubmit1);
		//finalsubmit.click();
	}
	...
	@FindBy(xpath = "//select[@id='ddlChemicalType']")
	private WebElement Chemical_Type;

	public void Select_Chemical_Type(String pom) throws Exception

	{

		// Lincence_sub_Type.click();
		Select s1 = new Select(Chemical_Type);
		Thread.sleep(3000);
	...
	@FindBy(xpath = "//select[@id='ddlSingleComFormula']")

	private WebElement Composite_Formula_of_Insecticide;

	public void enter_Composite_Formula_of_Insecticide(String Machinery ) throws Exception {

		// Thread.sleep(3000);

		Composite_Formula_of_Insecticide.sendKeys(Machinery);

}
	
	
	@FindBy(xpath = "//input[@id='TradeName']")

	private WebElement Trade_Name;

	public void enter_Trade_Name(String Machinery ) throws Exception {

		// Thread.sleep(3000);

		Trade_Name.sendKeys(Machinery);

}
	
	@FindBy(xpath = "//input[@id='RCNo']")

	private WebElement rcnum;

	public void enter_RC_Num(String Machinery ) throws Exception {

		// Thread.sleep(3000);

		rcnum.sendKeys(Machinery);
	...
	public void click_on_Date_of_Purchase () {
	 ...
	 @FindBy(xpath = "//input[@id='InsRCDate']")
		
		private WebElement RCDate;
		
		public void click_on_RCDate() {
 ...
 */
   ...
   @FindBy(xpath = "//input[@id='labEquipment_PurchaseDate']")
  	...
  	//MPCB Certificate
  	 ...
  	 @FindBy(xpath = "//input[@id='MPCBOperateNo']")
     ...
     @FindBy(xpath = "//input[@id='MPCBConsentDate']")
    ...
    @FindBy(xpath = "//input[@id='MPCBValidUpto']")
   	...
   	@FindBy(xpath = "//input[@id='DicAdharNo']")
