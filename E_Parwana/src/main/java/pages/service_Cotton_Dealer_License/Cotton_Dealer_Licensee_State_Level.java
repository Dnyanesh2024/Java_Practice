...
public class Cotton_Dealer_Licensee_State_Level {
...
WebDriver driver;
	...
	public Cotton_Dealer_Licensee_State_Level(WebDriver driver) {
		this.driver = driver;
...
//	@FindBy(xpath = "//p[ substring-before(text(), '-')='APPLICANT INFORMATION SAVED SUCCESSFULLY ' ]")
	...
	public void write_Application_ID() throws Exception {
		...
		ExcelWritter er = new ExcelWritter(
				"C:\\Users\\Swapnil.Gedam\\eclipse-workspacemahait\\E_Parwana\\src\\main\\resources\\Cotton_Dealer_License_State.xlsx",
				0);
