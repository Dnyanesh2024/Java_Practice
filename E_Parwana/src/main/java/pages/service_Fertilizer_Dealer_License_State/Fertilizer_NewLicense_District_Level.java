package pages.service_Fertilizer_Dealer_License_State;
...
public class Fertilizer_NewLicense_District_Level {

	WebDriver driver;
	
	String Excel_path;

	public Fertilizer_NewLicense_District_Level(WebDriver driver) {
		this.driver = driver;
  ...
  Thread.sleep(5000);
	...
	private WebElement districtchosses;

	public void Select_district(String dit) throws Exception {
		
	//	districtchosses.click();
		Select s1 = new Select(districtchosses);
		Thread.sleep(4000);
		s1.selectByVisibleText(dit);
	}
