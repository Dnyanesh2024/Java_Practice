...
public class Fertilizer_NewLicense_State_Level {

	WebDriver driver;
	
	String Excel_path;

	public Fertilizer_NewLicense_State_Level(WebDriver driver) {
		this.driver = driver;
...
//	@FindBy(xpath = "//p[ substring-before(text(), '-')='APPLICANT INFORMATION SAVED SUCCESSFULLY ' ]")
	...
	public void write_Application_ID() throws Exception {
		...
		ExcelWritter er = new ExcelWritter(
				"C:\\Users\\Swapnil.Gedam\\eclipse-workspacemahait\\E_Parwana\\src\\main\\resources\\Eprawana_Fertilizer_District.xlsx",
				0);
...
@FindBy(xpath = "//select[@class='ui-datepicker-year']")
	...
	public void enter_Search_Application_Id(String search_Id) throws Exception {
		 ...
		 * alert.accept();
		 * 
		 * alert.accept();alert.accept();alert.accept();alert.accept();
		 */
	}
