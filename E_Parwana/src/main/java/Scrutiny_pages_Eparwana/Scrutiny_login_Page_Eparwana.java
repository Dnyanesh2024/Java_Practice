package Scrutiny_pages_Eparwana;
...
public class Scrutiny_login_Page_Eparwana {
	
	SoftAssert assert1=new SoftAssert();
	WebDriver driver;
	public  Scrutiny_login_Page_Eparwana(WebDriver driver ) {
		this.driver=driver;
...
/// scrutinity dashboard
		...
		public void click_On_Go_For_Scrutiny() {
			Scrutiny.click();
		}
