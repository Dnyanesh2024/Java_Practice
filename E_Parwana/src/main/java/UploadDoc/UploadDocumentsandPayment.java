...
public class UploadDocumentsandPayment {
	
	
	WebDriver driver;

	public UploadDocumentsandPayment(WebDriver driver) {
		this.driver = driver;
...
///Applicant Information
   ...
   @FindBy(xpath = "//input[@id='file_31']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_31']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_32']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_33']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_34']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_35']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_36']")
	...
	@FindBy(xpath = "//span[text()='Step 2: Information of the Firm/Organization']")
	   ...
	   @FindBy(xpath = "//input[@id='file_37']")
		...
		@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_37']")
			...
			public void click_On_Upload_FormA1Button() throws Exception {
			  ...
			  @FindBy(xpath = "//input[@id='file_41']")
				...
				public void click_On_Upload_Assurance_Certificate_Button() throws Exception {
				  ...
				  @FindBy(xpath = "//input[@id='file_306']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_306']")
					...
					@FindBy(xpath = " //div/div[2]/div/div[3]/div/div[2]/div[1]/div/div[3]/input")
					...
					@FindBy(xpath = "//div/div[2]/div/div[3]/div/div[2]/div[2]/div/div[3]/input")
					...
					@FindBy(xpath = "//div/div[3]/div/div[2]/div[2]/div/div[4]/button[1]")
					...
					@FindBy(xpath = "//div/div[2]/div/div[3]/div/div[2]/div[3]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[3]/div/div[2]/div[3]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[2]/div/div[3]/div/div[2]/div[4]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[3]/div/div[2]/div[4]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[2]/div/div[3]/div/div[2]/div[5]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[3]/div/div[2]/div[5]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[2]/div/div[3]/div/div[2]/div[6]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[3]/div/div[2]/div[6]/div/div[4]/button[1]")
...
@FindBy(xpath = "//span[text()='Step 4: Sales Address Details']")
...
@FindBy(xpath = "//div[2]/div/div[4]/div/div[2]/div[1]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[2]/div/div[4]/div/div[2]/div[1]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[5]/div/div[2]/div[1]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[5]/div/div[2]/div[1]/div/div[4]/button[1]")
...
@FindBy(xpath = "//span[text()='Step 9: GRAS Payment']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_63']")
