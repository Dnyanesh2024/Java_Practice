package Scrutiny_Flow_fertilizer_Manufacture_Pages;
...
public class Scrutiny_login_Page_Eparwana_Fert_Manufac {
	
	SoftAssert assert1=new SoftAssert();
	WebDriver driver;
	public  Scrutiny_login_Page_Eparwana_Fert_Manufac(WebDriver driver ) {
		this.driver=driver;
...
@FindBy(xpath = "//span[text()='ServiceAccess']")
       ...
       @FindBy(xpath = "//a[text()='Responsible Person']")
		...
		public void click_on_firm_Responsible_Person_link() {
		 ...
		 @FindBy(xpath = "//a[text()='Fertilizer Type Grade Details']")
			...
			public void click_on_Sales_Address_Details_link() {
			 ...
			 @FindBy(xpath = "//a[text()='POM Details']")
              ...
              @FindBy(xpath = "//a[text()='Production Machinery Details']")
				...
				public void click_on_production_Machinerty_Details_link() {
				 ...
				 @FindBy(xpath = "//div/div[2]/div[2]/div/div/div/div[5]/div/table/tbody/tr/td[1]/div/div/span")
              ...
              @FindBy(xpath = "//button[@class='btn btn-info redirectToDashboard' and  @value='Forward_2741']")
...
@                   FindBy(xpath = "//button[@class='btn btn-info redirectToDashboard' and  @value='Forward_3048']")
					...
					@FindBy(xpath = "//li[2]//span[text()='Approved']")
