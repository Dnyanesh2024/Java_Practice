...
public class UploadDocumentsandPayment_cotton_Dealer {
	WebDriver driver;

	public UploadDocumentsandPayment_cotton_Dealer(WebDriver driver) {
		this.driver = driver;
...
///Applicant Information
   ...
   @FindBy(xpath = "//input[@id='file_180']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_180']")
	...
	@FindBy(xpath = "//input[@id='file_181']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_181']")
	...
	@FindBy(xpath = "//input[@id='file_182']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_182']")
	...
	@FindBy(xpath = "//input[@id='file_184']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_184']")
	...
	@FindBy(xpath = "//input[@id='file_185']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_185']")
	...
	@FindBy(xpath = "//span[text()='Step 2: Information of the Firm/ Organization']")
	   ...
	   @FindBy(xpath = "//input[@id='file_187']")
		...
		@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_187']")
...
// FORMA
		  @FindBy(xpath = "//input[@id='file_190']")
			...
			@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_190']")
			...
			public void click_On_Upload_FormA1Button() throws Exception {
			  ...
			  @FindBy(xpath = "//input[@id='file_191']")
				...
				@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_191']")
				...
				public void click_On_Upload_Assurance_Certificate_Button() throws Exception {
				  ...
				  @FindBy(xpath = "//input[@id='file_192']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_192']")
					...
					@FindBy(xpath = "//input[@id='file_193']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_193']")
					...
					@FindBy(xpath = "//input[@id='file_194']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_194']")
					...
					@FindBy(xpath = "//input[@id='file_195']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_195']")
...
@FindBy(xpath = "//input[@id='file_196']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_196']")
...
@FindBy(xpath = "//input[@id='file_197']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_197']")
