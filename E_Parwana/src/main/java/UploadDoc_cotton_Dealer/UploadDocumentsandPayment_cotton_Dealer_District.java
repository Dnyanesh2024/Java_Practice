package UploadDoc_cotton_Dealer;
...
public class UploadDocumentsandPayment_cotton_Dealer_District {
	WebDriver driver;

	public UploadDocumentsandPayment_cotton_Dealer_District(WebDriver driver) {
		this.driver = driver;
...
///Applicant Information
   ...
   @FindBy(xpath = "//input[@id='file_218']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_218']")
	...
	@FindBy(xpath = "//input[@id='file_219']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_219']")
	...
	@FindBy(xpath = "//input[@id='file_220']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_220']")
	...
	@FindBy(xpath = "//input[@id='file_222']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_222']")
	...
	@FindBy(xpath = "//input[@id='file_223']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_223']")
	...
	@FindBy(xpath = "//span[text()='Step 2: Information of the Firm/ Organization']")
	   ...
	   @FindBy(xpath = "//input[@id='file_225']")
		...
		@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_225']")
...
// FORMA
		  @FindBy(xpath = "//input[@id='file_228']")
			...
			@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_228']")
			...
			public void click_On_Upload_FormA1Button() throws Exception {
			  ...
			  @FindBy(xpath = "//input[@id='file_229']")
				...
				@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_229']")
				...
				public void click_On_Upload_Assurance_Certificate_Button() throws Exception {
				  ...
				  @FindBy(xpath = "//input[@id='file_230']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_230']")
					...
					@FindBy(xpath = "//span[text()='Step 3: Sales Address Details']")
					...
					@FindBy(xpath = "//input[@id='file_231']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_231']")
					...
					@FindBy(xpath = "//input[@id='file_232']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_232']")
					...
					@FindBy(xpath = "//input[@id='file_233']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_233']")
...
@FindBy(xpath = "//input[@id='file_234']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_234']")
...
@FindBy(xpath = "//input[@id='file_235']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_235']")
...
@FindBy(xpath = "//div/div[3]/div/div[2]/div[1]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[3]/div/div[2]/div[1]/div/div[4]/button[1]")
...
@FindBy(xpath = "//span[text()='Step 4: Storage Address Details']")
...
@FindBy(xpath = "//div/div[4]/div/div[2]/div[1]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[4]/div/div[2]/div[1]/div/div[4]/button[1]")
...
@FindBy(xpath = "//input[@id='file_213']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_213']")
...
@FindBy(xpath = "//input[@id='dtpGrasChallanPayDate']")
...
public void enter_Date_Of_Birth() {
    ...
    WebElement date = driver.findElement(By.xpath("//input[@id='dtpGrasChallanPayDate']"));
    date.click();
    String dateval = "02/01/2025";
...
public void click_ON_Res_Save_Button() throws Exception {
	...
	// elementToBeClickable expected criteria
	     WebElement ele = wt.until(ExpectedConditions.elementToBeClickable(ressavebtn));
	Thread.sleep(3000);
...
public void click_On_ok_Button() throws Exception {
	 ...
	 WebDriverWait wt = new WebDriverWait(driver,Duration.ofSeconds(40));
		// elementToBeClickable expected criteria
		     WebElement eles = wt.until(ExpectedConditions.elementToBeClickable(okbtn));
		Thread.sleep(3000);
...
@FindBy(xpath = "//input[@id='file_240']")
...
@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_240']")
