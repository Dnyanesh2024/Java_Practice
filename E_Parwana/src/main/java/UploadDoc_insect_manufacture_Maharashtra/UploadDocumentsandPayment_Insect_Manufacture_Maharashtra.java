package UploadDoc_insect_manufacture_Maharashtra;
...
public class UploadDocumentsandPayment_Insect_Manufacture_Maharashtra {
	
	
	WebDriver driver;

	public UploadDocumentsandPayment_Insect_Manufacture_Maharashtra(WebDriver driver) {
		this.driver = driver;
...
///Applicant Information
   ...
   @FindBy(xpath = "//input[@id='file_253']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_253']")
	...
	@FindBy(xpath = "//input[@id='file_254']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_254']")
	...
	@FindBy(xpath = "//input[@id='file_255']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_255']")
	...
	@FindBy(xpath = "//input[@id='file_256']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_256']")
	...
	@FindBy(xpath = "//input[@id='file_257']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_257']")
	...
	@FindBy(xpath = "//input[@id='file_258']")
	...
	@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_258']")
	...
	@FindBy(xpath = "//span[text()='Step 2: Firm/Organization Information']")
	   ...
	   @FindBy(xpath = "//input[@id='file_260']")
		...
		@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_260']")
...
// FORMA
		  @FindBy(xpath = "//input[@id='file_259']")
			...
			@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_259']")
			...
			public void click_On_Upload_FormA1Button() throws Exception {
			  ...
			  @FindBy(xpath = "//input[@id='file_264']")
				...
				@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_264']")
				...
				public void click_On_Upload_Assurance_Certificate_Button() throws Exception {
				  ...
				  @FindBy(xpath = "//input[@id='file_265']")
					...
					public void select_Authenticity_of_Firm(String fle) throws InterruptedException {
					  ...
					  @FindBy(xpath = "//input[@id='file_266']")

						private WebElement file366;

						public void select_Affidivit(String fle) throws InterruptedException {
							Thread.sleep(2000);
							file366.sendKeys(fle);
						}
						
					
					 @FindBy(xpath = "//div/div[5]/div/fieldset/div/div[2]/div/div[3]/input")
						...
						@FindBy(xpath = "//div/div[5]/div/fieldset/div/div[3]/div/div[3]/input")

						private WebElement Specimen_copies;

						public void select_Specimen_copies (String fle) throws InterruptedException {
							Thread.sleep(2000);
							Specimen_copies.sendKeys(fle);
						}
						
						@FindBy(xpath = "//div/div[5]/div/fieldset/div/div[4]/div/div[3]/input")

						private WebElement Production_Flow_Chart;

						public void select_Production_Flow_Chart(String fle) throws InterruptedException {
							Thread.sleep(2000);
							Production_Flow_Chart.sendKeys(fle);
						}
						
						
						@FindBy(xpath = "//div/div[5]/div/fieldset/div/div[5]/div/div[3]/input")

						private WebElement Method_of_Analysis;

						public void select_Production_Method_of_Analysis(String fle) throws InterruptedException {
							Thread.sleep(2000);
							Method_of_Analysis.sendKeys(fle);
						}
					
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_265']")
					...
					@FindBy(xpath = "//button[text()='Upload' and @id='btnUp_266']")

					private WebElement upladbtn366;

					public void click_On_Upload_Affidivit_Button() throws Exception {
					...
					@FindBy(xpath = "//div/div[5]/div/fieldset/div/div[2]/div/div[4]/button[1]")
					...
					@FindBy(xpath = "//div/div[5]/div/fieldset/div/div[3]/div/div[4]/button[1]")

					private WebElement Upload_Specimen_copies;

					public void click_On_Upload_Specimen_copies () throws Exception {

						Thread.sleep(4000);
						Upload_Specimen_copies.click();

			}
					
					
					@FindBy(xpath = "//div/div[5]/div/fieldset/div/div[4]/div/div[4]/button[1]")

					private WebElement productionflow ;

					public void click_On_Upload_productionflow () throws Exception {

						Thread.sleep(4000);
						productionflow .click();

			}
					
					@FindBy(xpath = "//div/div[5]/div/fieldset/div/div[5]/div/div[4]/button[1]")

					private WebElement Method_OF_anylisysi ;

					public void click_On_Upload_Method_OF_anylisysis () throws Exception {

						Thread.sleep(4000);
						Method_OF_anylisysi .click();
...
@FindBy(xpath = "//div/div[4]/div/fieldset/div/div[3]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[4]/div/fieldset/div/div[3]/div/div[4]/button[1]")
...
@FindBy(xpath = "//span[text()='Step 4: POM (Place of Manufacture)']")
...
@FindBy(xpath = "//span[text()='Step 5: Details of Insecticide']")
...
@FindBy(xpath = "//div/div[4]/div/fieldset/div/div[4]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[4]/div/fieldset/div/div[4]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[4]/div/fieldset/div/div[1]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[6]/div/fieldset/div/div[1]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[6]/div/fieldset/div/div[2]/div/div[3]/input")

private WebElement dic;

public void select_dic_Documents(String fle) throws InterruptedException {
	Thread.sleep(2000);
	dic.sendKeys(fle);
}


@FindBy(xpath = "//div/div[7]/div/fieldset/div/div[1]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[7]/div/fieldset/div/div[2]/div/div[3]/input")
...
@FindBy(xpath = "//div/div[7]/div/fieldset/div/div[3]/div/div[3]/input")

private WebElement Aadhar_Card_Proof;

public void select_Aadhar_Card_Proof(String fle) throws InterruptedException {
	Thread.sleep(2000);
	Aadhar_Card_Proof.sendKeys(fle);
}
@FindBy(xpath = "//div/div[4]/div/fieldset/div/div[1]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[7]/div/fieldset/div/div[3]/div/div[4]/button[1]")

private WebElement Aadhar_Card_Proof_Button;

public void click_On_Upload_Aadhar_Card_Proof_Button() throws InterruptedException {
	
	Thread.sleep(4000);
	Aadhar_Card_Proof_Button.click();
}

@FindBy(xpath = "//div/div[6]/div/fieldset/div/div[1]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[6]/div/fieldset/div/div[2]/div/div[4]/button[1]")

private WebElement dic_Documents_Button;

public void click_On_Upload_dic_Documents_Button() throws InterruptedException {
	
	Thread.sleep(4000);
	dic_Documents_Button.click();
}

@FindBy(xpath = "//div/div[7]/div/fieldset/div/div[1]/div/div[4]/button[1]")
...
@FindBy(xpath = "//div/div[7]/div/fieldset/div/div[2]/div/div[4]/button[1]")
...
@FindBy(xpath = "//span[text()='Step 6: MPCB and DIC of Manufacturer']")
...
@FindBy(xpath = "//span[text()='Step 7: Experts Staff Details of Manufacture']")
