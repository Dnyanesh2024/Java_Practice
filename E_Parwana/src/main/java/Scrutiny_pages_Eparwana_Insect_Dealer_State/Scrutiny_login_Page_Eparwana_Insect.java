package Scrutiny_pages_Eparwana_Insect_Dealer_State;
...
public class Scrutiny_login_Page_Eparwana_Insect {
	
	SoftAssert assert1=new SoftAssert();
	WebDriver driver;
	public  Scrutiny_login_Page_Eparwana_Insect(WebDriver driver ) {
		this.driver=driver;
...
@FindBy(xpath = "//span[text()='ServiceAccess']")
       ...
       @FindBy(xpath = "//a[text()='Next']")
		...
		@FindBy(xpath = "//a[text()='Firm / Organization Information']")
       ...
       @FindBy(xpath = "//a[text()='Responsible Person Details']")
		...
		public void click_on_firm_Responsible_Person_link() {
		 ...
		 @FindBy(xpath = "//a[text()='Place of Business (SALES and Storage)']")
			...
			public void click_on_Sales_Address_Details_link() {
			 ...
			 @FindBy(xpath = "//a[text()='Details of Insecticide']")
				...
				public void click_on_Storage_Address_Details_link() {
				 ...
				 @FindBy(xpath = "//div/div/div/div[5]/div/table/tbody/tr/td[1]/div/div/span")
              ...
              @FindBy(xpath = "//button[@class='btn btn-info redirectToDashboard' and  @value='Forward_2988']")
...
@                   FindBy(xpath = "//button[@class='btn btn-info redirectToDashboard' and  @value='Forward_3048']")
					...
					@FindBy(xpath = "//li[6]//span[text()='Approved']")
