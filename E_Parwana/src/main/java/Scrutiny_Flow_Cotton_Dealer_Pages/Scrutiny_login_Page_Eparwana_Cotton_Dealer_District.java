...
public class Scrutiny_login_Page_Eparwana_Cotton_Dealer_District {
	
	SoftAssert assert1=new SoftAssert();
	WebDriver driver;
	public  Scrutiny_login_Page_Eparwana_Cotton_Dealer_District(WebDriver driver ) {
		this.driver=driver;
		 ...
		 @FindBy(xpath = "//a[text()='Crop Varieties Details']")
			...
			public void click_on_Sales_Address_Details_link() {
			 ...
			 @FindBy(xpath = "//a[text()='Storage Address Details']")
              ...
              @FindBy(xpath = "//button[@class='btn btn-info redirectToDashboard' and  @value='Forward_2853']")
